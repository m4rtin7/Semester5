...
func main() {
	...
	newGame := func() {
		ship = spaceShip{
			x: (windowWidthSmall - shipSize) / 2,
			y: windowHeightSmall - 10 - shipSize,
		}
		bullets = nil
		nextBulletLock = 0
	...
	err := draw.RunWindow("Space Shooter", windowWidthSmall, windowHeightSmall, func(window draw.Window) {
